# Approach
In the [core concepts](core_concepts.md) section it was mentioned to _abide by the store contract_ when developing your application. What exactly does this mean in the context of the typical Angular setup and workflow which you have grown accustomed? Let's take a look. 
...
![counter two-way](http://imgur.com/3BKGnFh.png)
###### <sup>2</sup> One Way Data-Flow
![counter one-way](http://imgur.com/M7JRbyS.png)
